...
from model_transf import TrainerT
...
def main(args, device, model_load_dir, model_save_dir, results_save_dir):
    ...
    if args.action == 'train' and args.extract_save_pseudo_labels == 0:
        print("Ready to train TRANSFORMER MODEL...")
...
def init_args():
    ...
    #### Transformer
    parser.add_argument("--dim_model", default = 1024, type=int)
    parser.add_argument("--num_heads", default = 8, type=int, help = "Number of heads in transformer encoder")
    parser.add_argument("--num_encoder_layers", default = 8, type=int, help="Number of encoder layers")
    parser.add_argument("--dim_feedforward_encoder", default = 2048, type=int, help= "Diension of the transformer encoder feedforward layer")
    parser.add_argument("--dropout", default = 0.4, type=float, help = "Dropout in transformer encoder")
...
if __name__ == "__main__":
    ...
    print("Device:", device)
    args = init_args()
    model_load_dir, model_save_dir, results_save_dir = create_folders(args, type = "New")
