            ...
            while batch_gen.has_next():
                ...
                for ix, p in enumerate(predictions):
                    if self.num_classes == 1:
                        ...
                        # print("Detail before CE")
                        # print(p.transpose(2, 1).contiguous().view(-1, self.num_classes))
                        # print(p.transpose(2, 1).contiguous().view(-1, self.num_classes).shape)
                        # print(batch_target.view(-1))
                        # print(batch_target.view(-1).shape)
