...
def create_folders(args, type = "Old"):
    ...
    Args:
        args: 
            args: parser arguments.
            type: "Old" if using original paper training, "New" is using transformer training
    Returns:
    ...
    if type == "Old":
        ...
        model_save_dir = f"./exps/{args.folder}/models/{train_type}/traindata_{train_data}/{args.i3d_training}/{ssl_str}/{args.num_heads}_{args.num_encoder_layers}_{args.dim_feedforward_encoder}_{args.dropout}_{bz}_{lr}_{weighted_str}/seed_{args.seed}"
